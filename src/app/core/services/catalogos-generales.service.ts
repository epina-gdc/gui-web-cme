...
export class CatalogosGeneralesService {
  ...
  getCatalogoSexo(): Observable<any> {
    return this.http.get(this.serverEndPointURL + '/sexos', {headers: this.header})
  }

  getCatalogoEstadoCivil(): Observable<any> {
    return this.http.get(this.serverEndPointURL + '/estados-civiles', {headers: this.header})
  }
